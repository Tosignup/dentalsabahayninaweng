    ...
    <div class="flex p-4 justify-between align-center shadow-lg">
        ...
        <div class="flex gap-6 justify-center items-center">
            ...
            @if( Auth::user()->role === 'client')
                ...
                <a class="flex gap-6 justify-center items-center" href="{{route('client.dashboard')}}">
                    <h1 class="py-2 px-4 rounded-md text-white font-semibold bg-green-600 hover:bg-green-700 transition-all cursor-pointer">
                     PROFILE</h1>
                </a>
                @endif
            @endauth

            ...
            <div class="bg-green-600 rounded-lg text-white p-8 flex flex-col justify-between">
                <div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-4 mb-8">
                        ...
                        <a class="text-sm hover:font-semibold transition-all" href="{{ route('password.request') }}">Forgot your password?</a>
                        <button class="bg-slate-200 max-w-min text-slate-900 font-bold py-2 px-8 rounded-md hover:bg-slate-900 hover:text-slate-100 transition-all">Login</button>
                    </form>
                </div>
